...
(function() {
    var provider = app.data.demoOrdenes = new Everlive({
            offlineStorage: true,
            appId: '7pbvkyo3m0rklixb',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'demoOrdenes_access_token',
...
// START_CUSTOM_CODE_demoOrdenes
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_demoOrdenes